...
function funChgTgtTypeCd(){
	if(tgtTypeCd.value =="CATE_CONT"){ //구분
        param.value.word = ""
                    ...
                    <div class="table-search-wrap">
                        ...
                        <div class="table-search">
                            <select id="tgtTypeCd" name="tgtTypeCd" title="검색어 분류 선택" @change="funChgTgtTypeCd()" v-model="tgtTypeCd"
                                ...
                                <option value="CATE_CONT">구분</option>
                            </select>
                            <div class="input-wrap">
                                <select v-show="searchKey2" id="searchKey2" name="searchKey2" class="select-type2" title="구분 선택"
                                    ...
                                    <option value="nd01">행사</option>
                                    <option value="nd02">이벤트</option>
                                    <option value="nd03">서비스운영</option>
...
.table-type1 td {padding:10px;/* padding:15px 0;*/  text-align: center; vertical-align: middle;}
.table-type1 thead { border-bottom: 1px solid #d3d3d3;}
.table-type1 thead th {padding: 10px 0; font-size: 16px; font-weight: 500; vertical-align: middle; border-top: 1px solid #e4e4e4; background-color: #f7f7f7;}
.table-type1 tbody tr {border-bottom: 1px solid #e4e4e4;}
.table-type1 tbody th{padding:15px 10px; font-weight:500; vertical-align: middle;}
.table-type1 tbody td a {font-size: 17px; word-break: keep-all;} 
.table-type1 tbody td a:hover {text-decoration: underline;} 
.table-type1 tbody td.subject {padding-left:10px; text-align: left;}
.table-type1 td{vertical-align: middle;}



.table-wrap .table-type1.fixed-head th {position: sticky; top: 0; border-top: 1px solid #888888; background-color: #f7f7f7;}
...
.table-division2 {color:#007bab !important; border:1px solid #007bab !important;} /*서비스운영*/
.table-division3 {color:#c74b10 !important; border:1px solid #c74b10 !important;} /*행사*/
