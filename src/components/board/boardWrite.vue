<script setup>
    ...
    const article = ref({
        ...
        type: memberStore.memberInfo.status == "ADMIN" ? "notice" : "community"
     });
...
function writeArticle() {
  ...
  registArticle(
    ...
    (response) => {
      ...
      article.value.boardNo = response.data;
      alert(msg);
      router.push({ name: "boardDetail" , params: {boardno: article.value.boardNo} });
    },
    ...
    <div class="inner">
        <div class="table-wrap">
            ...
            <table class="table-type2 table-1">
                <caption>글 작성 - 제목 작성자 등록일자, 내용으로 구성</caption>
                <thead>
                    <tr>
                        <th>
                            <div class="clearfix">
        ...
        <div class="clearfix btn-wrap align-right mt30 mb30">
            <button class="table-btn btn-write btn_bbsList" @click="onSubmit">글쓰기</button>
